...
export const ALL_PERMISSIONS: Permission[] = [
  ...
  {
    id: 'annadhanam_approval',
    name: 'Annadhanam Approval',
    description: 'Approve or reject Annadhanam mobile requests',
    icon: '🍛',
    href: '/dashboard/annadhanam/approval',
    requiredRole: ['admin', 'superadmin']
  }
  ,
  {
    id: 'donation_approval',
    name: 'Donations Approval',
    description: 'Approve or reject donations submitted from mobile app',
    icon: '🎁',
    href: '/dashboard/donations/approval',
    requiredRole: ['admin', 'superadmin']
  }
  ,
  {
    id: 'receipts',
    name: 'Receipts',
    description: 'Manage income/expense receipts',
    icon: '🧾',
...
export const permissions = {
  ...
  annadhanam_approval: {
    id: 'annadhanam_approval',
    name: 'Annadhanam Approval',
    description: 'Allows approving/rejecting Annadhanam mobile requests'
  },
  donation_approval: {
    id: 'donation_approval',
    name: 'Donations Approval',
    description: 'Allows approving/rejecting donations submitted from mobile app'
  },
  receipts: {
    id: 'receipts',
    name: 'Receipts',
