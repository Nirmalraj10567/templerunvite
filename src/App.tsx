...
import RegisterPage from './pages/RegisterPage'; // default export - no braces
                ...
                <Route element={<ProtectedRoute />}>
                  <Route path="dashboard" element={<DashboardLayout />}>
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="balance_sheet"
                          accessLevel="view"
                        >
                          <BalanceSheet />
                        </PermissionGuard>
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="user_registrations"
                          accessLevel="edit"
                        >
                          <YearEndLockGuard>
                            <TempleUserEntryPage />
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="tax_registrations"
                          accessLevel="edit"
                        >
                          <YearEndLockGuard>
                            <TaxUserEntryPage />
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="property_registrations"
                          accessLevel="view"
                        >
                          <PropertyRoutes />
                        </PermissionGuard>
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="view_kanikalar"
                          accessLevel="view"
                        >
                          <KanikalarPage />
                        </PermissionGuard>
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="pdf_settings"
                          accessLevel="edit"
                        >
                          <PdfSettingsPage />
                        </PermissionGuard>
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="member_entry"
                          accessLevel="edit"
                        >
                          <YearEndLockGuard>
                            <MemberEntryPage />
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="view_session_logs"
                          accessLevel="view"
                        >
                          <MemberLogsPage />
                        </PermissionGuard>
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="marriage_register"
                          accessLevel="edit"
                        >
                          <YearEndLockGuard>
                            <MarriageEntryPage />
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="hall_booking"
                          accessLevel="edit"
                        >
                          <YearEndLockGuard>
                            <HallEntryPage />
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="hall_approval"
                          accessLevel="view"
                        >
                          <HallApprovalPage />
                        </PermissionGuard>
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="annadhanam_registrations"
                          accessLevel="edit"
                        >
                          <YearEndLockGuard>
                            <AnnadhanamEntryPage />
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="pooja_registrations"
                          accessLevel="edit"
                        >
                          <YearEndLockGuard>
                            <PoojaEntryPage />
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="pooja_mobile_submit"
                          accessLevel="edit"
                        >
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="pooja_approval"
                          accessLevel="view"
                        >
                          <PoojaApprovalPage />
                        </PermissionGuard>
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="annadhanam_approval"
                          accessLevel="view"
                        >
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="donation_approval"
                          accessLevel="view"
                        >
                    ...
                    <Route
                      ...
                      element={
                        <PermissionGuard
                          requiredPermission="session_management"
                          accessLevel="view"
                        >
                  ...
                  {/* Session logs direct route with permission */}
                  <Route
                    path="/session-logs"
                    element={
                      <PermissionGuard
