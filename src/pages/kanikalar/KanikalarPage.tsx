...
const KanikalarPage: React.FC = () => {
  ...
  const fetchWeddings = async () => {
    try {
      setLoading(true);
      const response = await fetch('https://templeapi.agniplay.com/api/kanikalar', {
        headers: {
  ...
  const confirmDelete = async () => {
    ...
    try {
      const response = await fetch(`https://templeapi.agniplay.com/api/kanikalar/${weddingToDelete}`, {
        method: 'DELETE',
        headers: {
          'Authorization': `Bearer ${token}`
        }
