  ...
  const submit = async () => {
    ...
    try {
      ...
      const payload = {
        ...
        mobileNumber: form.mobileNumber.replace(/\D/g, ''), // Remove formatting
        aadhaarNumber: form.aadhaarNumber.replace(/\D/g, ''), // Remove formatting
        panNumber: form.panNumber,
        clan: form.clan,
        group: form.group,
        postalCode: form.postalCode,
        maleHeirs: form.maleHeirs,
        femaleHeirs: form.femaleHeirs,
        year: form.year,
