            ...
            <div className="flex flex-wrap gap-3 items-end justify-between mb-4">
              <div className="flex flex-wrap gap-3 items-end">
                <div>
                  ...
                  <select className={cn(theme.select.base, theme.select.size.sm, "rounded")} value={year} onChange={(e) => { setYear(parseInt(e.target.value, 10)); fetchReport(parseInt(e.target.value, 10), month); }}>
                ...
                <div>
                  ...
                  <select className={cn(theme.select.base, theme.select.size.sm, "rounded")} value={month} onChange={(e) => { setMonth(parseInt(e.target.value, 10)); fetchReport(year, parseInt(e.target.value, 10)); }}>
