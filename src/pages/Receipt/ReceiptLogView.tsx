...
export default function ReceiptLogView({ recentOnly = false }: ReceiptLogViewProps) {
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>{t('Receipt ID', 'பதிவு ஐடி')}</TableHead>
              ...
              {logs.length === 0 ? (
                ...
                logs.map((lg) => (
                  <TableRow key={lg.id}>
                    ...
                    <TableCell>{lg.receipt_id}</TableCell>
                    <TableCell>{lg.receipt_name ?? '-'}</TableCell>
                    <TableCell>
                      {(() => {
                          ...
                          return (
                            <div className="space-y-2">
                              <div className="bg-orange-50 p-3 rounded border text-xs">
                                <div className="font-medium text-orange-700 mb-2">{t('Receipt Details', 'பதிவு விவரங்கள்')}</div>
                                <div className="space-y-1 text-gray-600">
                                  ...
                                  {fromPerson && (
                                    <div className="flex justify-between">
                                      <span className="font-medium">{t('From Person', 'பெறுநர்')}:</span>
                                      <span>{fromPerson}</span>
                                    </div>
                                  )}
                                  {toPerson && (
                                    <div className="flex justify-between">
                                      <span className="font-medium">{t('To Person', 'கொடுப்பவர்')}:</span>
                                      <span>{toPerson}</span>
                                    </div>
                                  )}
                                  {remarks && (
                                    <div className="flex justify-between">
                                      <span className="font-medium">{t('Remarks', 'குறிப்புகள்')}:</span>
                                      <span>{remarks}</span>
                                    </div>
                                  )}
                                </div>
