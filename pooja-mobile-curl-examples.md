...
```bash
curl -X GET https://templeapi.agniplay.com/api/pooja-mobile/requests \
  -H "Authorization: Bearer mobile_123"
```

### Get Requests with Status Filter
```bash
curl -X GET "https://templeapi.agniplay.com/api/pooja-mobile/requests?status=pending" \
  -H "Authorization: Bearer mobile_123"
```

### Get Requests with Date Range
```bash
curl -X GET "https://templeapi.agniplay.com/api/pooja-mobile/requests?from=2025-09-01&to=2025-09-30" \
  -H "Authorization: Bearer mobile_123"
```
...
```bash
curl -X GET "https://templeapi.agniplay.com/api/pooja-mobile/available-slots?date=2025-09-28" \
  -H "Authorization: Bearer mobile_123"
```

### Get Available Slots with Temple ID
```bash
curl -X GET "https://templeapi.agniplay.com/api/pooja-mobile/available-slots?date=2025-09-28&temple_id=1" \
  -H "Authorization: Bearer mobile_123"
```
...
```bash
export API_BASE_URL="https://templeapi.agniplay.com"
