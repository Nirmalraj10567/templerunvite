...
## Base URL
```
https://templeapi.agniplay.com/api/mobile-auth
```
...
1. **Send OTP**
```bash
curl -X POST https://templeapi.agniplay.com/api/mobile-auth/send-otp \
...
2. **Verify OTP**
```bash
curl -X POST https://templeapi.agniplay.com/api/mobile-auth/verify-otp \
  -H "Content-Type: application/json" \
  -d '{
    "mobileNumber": "9999999999",
    "name": "John Doe",
...
3. **Get Payment Details**
```bash
curl -X GET https://templeapi.agniplay.com/api/mobile-auth/payment-details/1 \
