...
CREATE TABLE `master_records` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT NOT NULL, `date` VARCHAR(255) not null, `name` VARCHAR(255) not null, `under` VARCHAR(255) not null, `opening_balance` VARCHAR(255) default '0', `balance_type` VARCHAR(255) default 'credit', `address_line1` VARCHAR(255) default '', `address_line2` VARCHAR(255) default '', `address_line3` VARCHAR(255) default '', `address_line4` VARCHAR(255) default '', `village` VARCHAR(255) default '', `telephone` VARCHAR(255) default '', `mobile` VARCHAR(255) default '', `email` VARCHAR(255) default '', `note` VARCHAR(255) default '', `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, foreign key(`temple_id`) references `temples`(`id`));
CREATE TABLE `master_people` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT NOT NULL, `name` VARCHAR(255) not null, `gender` VARCHAR(255), `dob` VARCHAR(255), `address` VARCHAR(255), `village` VARCHAR(255), `mobile` VARCHAR(255), `email` VARCHAR(255), `note` VARCHAR(255), `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, foreign key(`temple_id`) references `temples`(`id`));
CREATE TABLE `user_permissions` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `user_id` INT, `permission_id` VARCHAR(255) not null, `access_level` TEXT check (`access_level` in ('full', 'view', 'none')) default 'none', `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, foreign key(`user_id`) references `users`(`id`) on delete CASCADE);
CREATE UNIQUE INDEX `user_permissions_user_id_permission_id_unique` on `user_permissions` (`user_id`, `permission_id`);
CREATE TABLE `master_groups` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT DEFAULT '1', `name` VARCHAR(255) not null, `description` VARCHAR(255), `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE `master_clans` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT DEFAULT '1', `name` VARCHAR(255) not null, `description` VARCHAR(255), `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE `master_occupations` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT DEFAULT '1', `name` VARCHAR(255) not null, `description` VARCHAR(255), `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE `master_villages` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT DEFAULT '1', `name` VARCHAR(255) not null, `description` VARCHAR(255), `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE `master_educations` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT DEFAULT '1', `name` VARCHAR(255) not null, `description` VARCHAR(255), `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE `activity_logs` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT NOT NULL, `actor_user_id` INT NOT NULL, `action` VARCHAR(255) not null, `target_table` VARCHAR(255), `target_id` INT, `details` TEXT, `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE `superadmin_logs` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `user_id` INT NOT NULL, `action` VARCHAR(255) not null, `ip_address` VARCHAR(255) not null, `user_agent` VARCHAR(255), `timestamp` DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE `session_logs` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `user_id` INT NOT NULL, `login_time` DATETIME DEFAULT CURRENT_TIMESTAMP, `logout_time` datetime, `ip_address` VARCHAR(255) not null, `user_agent` VARCHAR(255), `duration_seconds` integer);
CREATE TABLE IF NOT EXISTS "user_registrations" (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT DEFAULT '1', `reference_number` VARCHAR(255), `date` VARCHAR(255), `subdivision` VARCHAR(255), `name` VARCHAR(255) not null, `username` VARCHAR(255), `email` VARCHAR(255), `alternative_name` VARCHAR(255), `wife_name` VARCHAR(255), `education` VARCHAR(255), `occupation` VARCHAR(255), `father_name` VARCHAR(255), `address` VARCHAR(255), `birth_date` VARCHAR(255), `village` VARCHAR(255), `mobile_number` VARCHAR(255), `aadhaar_number` VARCHAR(255), `pan_number` VARCHAR(255), `clan` VARCHAR(255), `group` VARCHAR(255), `postal_code` VARCHAR(255), `male_heirs` INT DEFAULT '0', `female_heirs` INT DEFAULT '0', `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, photo_path TEXT);
CREATE TABLE `marriage_registers` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT NOT NULL default '1', `register_no` VARCHAR(255), `date` VARCHAR(255), `time` VARCHAR(255), `event` VARCHAR(255), `groom_name` VARCHAR(255), `bride_name` VARCHAR(255), `address` VARCHAR(255), `village` VARCHAR(255), `guardian_name` VARCHAR(255), `witness_one` VARCHAR(255), `witness_two` VARCHAR(255), `remarks` VARCHAR(255), `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, amount INTEGER DEFAULT 0);
CREATE TABLE `marriage_hall_bookings` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT NOT NULL default '1', `register_no` VARCHAR(255), `date` VARCHAR(255), `time` VARCHAR(255), `event` VARCHAR(255), `subdivision` VARCHAR(255), `name` VARCHAR(255), `address` VARCHAR(255), `village` VARCHAR(255), `mobile` VARCHAR(255), `advance_amount` VARCHAR(255), `total_amount` VARCHAR(255), `balance_amount` VARCHAR(255), `remarks` VARCHAR(255), `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, status TEXT DEFAULT 'approved' CHECK (status IN ('pending', 'approved', 'rejected', 'cancelled')), submitted_by_mobile TEXT, approved_by INTEGER REFERENCES users(id) ON DELETE SET NULL, approved_at TIMESTAMP, rejection_reason TEXT, admin_notes TEXT, submitted_at TIMESTAMP, transfer_to_account TEXT, hall_id INTEGER, event_id INTEGER);
CREATE TABLE `user_tax_registrations` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT DEFAULT '1', `reference_number` VARCHAR(255), `date` VARCHAR(255), `subdivision` VARCHAR(255), `name` VARCHAR(255) not null, `alternative_name` VARCHAR(255), `wife_name` VARCHAR(255), `education` VARCHAR(255), `occupation` VARCHAR(255), `father_name` VARCHAR(255), `address` VARCHAR(255), `birth_date` VARCHAR(255), `village` VARCHAR(255), `mobile_number` VARCHAR(255), `aadhaar_number` VARCHAR(255), `pan_number` VARCHAR(255), `clan` VARCHAR(255), `group` VARCHAR(255), `postal_code` VARCHAR(255), `male_heirs` INT DEFAULT '0', `female_heirs` INT DEFAULT '0', `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, amount_paid DECIMAL(10,2) DEFAULT 0, outstanding_amount DECIMAL(10,2) DEFAULT 0, is_approved BOOLEAN DEFAULT 0, approved_by INTEGER REFERENCES users(id), approved_at TIMESTAMP, note TEXT, year INTEGER, tax_amount DECIMAL(10,2) DEFAULT 0, transfer_to_account TEXT, donation_amount DECIMAL(10,2) DEFAULT 0);
CREATE TABLE `tax_settings` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT NOT NULL, `year` INT NOT NULL, `tax_amount` FLOAT not null, `description` VARCHAR(255), `is_active` BOOLEAN default '1', `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `include_previous_years` BOOLEAN default '0');
...
CREATE TABLE `knex_migrations` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `name` VARCHAR(255), `batch` INT, `migration_time` datetime);
CREATE TABLE `knex_migrations_lock` (`index` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `is_locked` integer);
CREATE TABLE `annadhanam` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT NOT NULL default '1', `receipt_number` VARCHAR(255) not null, `name` VARCHAR(255) not null, `mobile_number` VARCHAR(255) not null, `food` TEXT not null, `peoples` INT NOT NULL, `time` VARCHAR(255) not null, `from_date` date not null, `to_date` date not null, `remarks` TEXT, `created_by` INT, `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, status TEXT DEFAULT 'approved' CHECK (status IN ('pending','approved','rejected','cancelled')), submitted_by_mobile TEXT, submitted_at TIMESTAMP, approved_at TIMESTAMP, rejection_reason TEXT, admin_notes TEXT, approved_by INTEGER, foreign key(`created_by`) references `users`(`id`) on delete SET NULL, foreign key(`temple_id`) references `temples`(`id`) on delete CASCADE);
...
CREATE TABLE `pooja` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT NOT NULL default '1', `receipt_number` VARCHAR(255) not null, `name` VARCHAR(255) not null, `mobile_number` VARCHAR(255) not null, `time` VARCHAR(255) not null, `from_date` date not null, `to_date` date not null, `remarks` TEXT, `created_by` INT, `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, status TEXT DEFAULT 'approved' CHECK (status IN ('pending', 'approved', 'rejected', 'cancelled')), submitted_by_mobile TEXT, approved_by INTEGER REFERENCES users(id) ON DELETE SET NULL, approved_at TIMESTAMP, rejection_reason TEXT, admin_notes TEXT, submitted_at TIMESTAMP, transfer_to_account TEXT, amount REAL, foreign key(`created_by`) references `users`(`id`) on delete SET NULL, foreign key(`temple_id`) references `temples`(`id`) on delete CASCADE);
...
CREATE TABLE `user_heirs` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `registration_id` INT NOT NULL, `serial_number` INT NOT NULL default '1', `name` VARCHAR(255) not null, `race` VARCHAR(255), `marital_status` VARCHAR(255), `education` VARCHAR(255), `birth_date` VARCHAR(255), `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, foreign key(`registration_id`) references `user_registrations`(`id`) on delete CASCADE);
...
CREATE TABLE `money_donations` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `register_no` VARCHAR(255), `date` VARCHAR(255) not null, `name` VARCHAR(255), `father_name` VARCHAR(255), `address` VARCHAR(255), `village` VARCHAR(255), `phone` VARCHAR(255), `amount` FLOAT not null, `reason` VARCHAR(255), `temple_id` INT NOT NULL, `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, transfer_to_account TEXT);
CREATE TABLE `pdf_settings` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT NOT NULL, `title_main` VARCHAR(255), `title_sub` VARCHAR(255), `title_line2` VARCHAR(512), `subheader` VARCHAR(255), `logo_url` VARCHAR(512), `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `tax_subheader` VARCHAR(255), `annadhanam_subheader` VARCHAR(255), `hall_subheader` VARCHAR(255), `watermark_TEXT` VARCHAR(255), `annadhanam_receipt_label` VARCHAR(255), `annadhanam_date_label` VARCHAR(255), `annadhanam_year_label` VARCHAR(255), `annadhanam_cell_label` VARCHAR(255), `annadhanam_collector_label` VARCHAR(255));
...
CREATE TABLE `master_halls` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT DEFAULT '1', `name` VARCHAR(255) not null, `base_price` FLOAT null, `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE `master_hall_events` (`id` INT NOT NULL PRIMARY KEY AUTO_INCREMENT, `temple_id` INT DEFAULT '1', `name` VARCHAR(255) not null, `created_at` DATETIME DEFAULT CURRENT_TIMESTAMP, `updated_at` DATETIME DEFAULT CURRENT_TIMESTAMP);
CREATE TABLE users (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
