...
async function testMobileCalendarAPI() {
  try {
    ...
    const todayResponse = await fetch(`http://localhost:4000e/calendar/today?mobile=9999999999&templeId=12`);
    ...
    const dateResponse = await fetch(`http://localhost:4000e/calendar/${today}?mobile=9999999999&templeId=12`);
    ...
    const rangeResponse = await fetch(`http://localhost:4000e/calendar/range?from=${today}&to=${today}&mobile=9999999999&templeId=12`);
